...
@RestController
@RequestMapping("/api/replenishment-kafka")
public class ReplenishmentKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ReplenishmentKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ReplenishmentKafkaResource(KafkaProperties kafkaProperties) {
